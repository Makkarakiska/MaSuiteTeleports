...
@Data
public class TeleportRequestServiceOLD {
    ...
    /**
     * A constructor for {@link TeleportRequestServiceOLD}
     *
     * @param sender   unique id of the sender
     * @param receiver unique id of the receiver
     * @param type     request {@link TeleportRequestServiceOLD}
     */
    public TeleportRequestServiceOLD(MaSuiteTeleports plugin, ProxiedPlayer sender, ProxiedPlayer receiver, TeleportRequestType type) {
        this.plugin = plugin;
        this.sender = sender;
    ...
    public void create() {
        ...
        if (this.type.equals(TeleportRequestType.REQUEST_TO)) {
            ...
            plugin.formator.sendMessage(receiver, messages
                    ...
                    .replace("%sender%", sender.getName())
                    .replace("%receiver%", receiver.getName()));
        } else if (this.type.equals(TeleportRequestType.REQUEST_HERE)) {
            plugin.formator.sendMessage(sender, messages
